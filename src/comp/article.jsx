...
class Article extends PureComponent {
  render() {
    return ( <div class="mainArticle">
      <h1>Le Sunfish</h1>
      <div class="backgrondColor"></div>
      <section class="molaArticle">
        <p>
        ...
        <div class="birdOnMolaSection">
          ...
          <img class="birdOnMola" alt="birdOnMola" src={birdOnMola}/>
        </div>
        <p>
      ...
      <img class="molaMola" alt="MolaMola" src={MolaMola}/>
    </div> )
  }
};
